...
class _TableDataSource extends DataTableSource {
  ...
  DataRow? getRow(int index) {
    ...
    if ((_filterTitle != null && !_rows[index]['title'].toLowerCase().contains(_filterTitle!.toLowerCase())) ||
        (_filterPrice != null && !_rows[index]['price'].toString().contains(_filterPrice!))) {
      return null;
    }
    return DataRow(cells: [
      DataCell(row['editable']
          ? TextField(
      ...
      DataCell(row['editable']
          ? TextField(
        controller: TextEditingController(text: row['price'].toString()),
        onChanged: (value) => row['price'] = value,
      )
          : Text('\$${row['price']}')),
